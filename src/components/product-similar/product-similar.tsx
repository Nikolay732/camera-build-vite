...
import { SimilarSwiperSetting } from '../../const';
import 'swiper/css';
      ...
      <div className="container">
        ...
        <div className="product-similar__slider">
          <div className="product-similar__slider-list">
            <Swiper
              slidesPerView={SimilarSwiperSetting.SlidesPerView}
              slidesPerGroup={SimilarSwiperSetting.SlidesPerGroup}
              spaceBetween={SimilarSwiperSetting.SpaceBetween}
              modules={[Navigation]}
              navigation={{
            ...
            >
              {similarProductList.map((product) => (
                <SwiperSlide key={product.id}>
                  <ProductCardItem product={product} isSimilarProduct/>
                </SwiperSlide>
              ))}
            </Swiper>
          </div>
